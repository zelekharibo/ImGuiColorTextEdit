...
void TextEditor::Render() {
    ...
    if (!mLines.empty()) {
        ...
        while (lineNo <= lineMax) {
            ...
            drawList->AddText(
                ImVec2(lineStartScreenPos.x + mTextStart - lineNoWidth, lineStartScreenPos.y), mPalette[(int)PaletteIndex::LineNumber], buf);
...
void TextEditor::Render(const char* aTitle, const ImVec2& aSize, bool aBorder) {
    ...
    if (!mIgnoreImGuiChild)
        ImGui::BeginChild(
            aTitle, aSize, aBorder, ImGuiWindowFlags_HorizontalScrollbar | ImGuiWindowFlags_AlwaysHorizontalScrollbar | ImGuiWindowFlags_NoMove);
...
void TextEditor::Delete() {
    ...
    if (HasSelection()) {
        ...
        if (pos.mColumn == GetLineMaxColumn(pos.mLine)) {
            ...
            auto d = UTF8CharLength(line[cindex].mChar);
            u.mRemovedStart = GetActualCursorCoordinates();
            u.mRemovedEnd = Coordinates(pos.mLine, GetCharacterColumn(pos.mLine, cindex + d));
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::CPlusPlus() {
    ...
    if (!inited) {
        ...
        langDef.mTokenize =
            [](const char* in_begin, const char* in_end, const char*& out_begin, const char*& out_end, PaletteIndex& paletteIndex) -> bool {
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL() {
    ...
    static LanguageDefinition langDef;
    if (!inited) {
        static const char* const keywords[] = {"auto",
            "break",
            "case",
            "char",
            "const",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::AngelScript() {
    ...
    static LanguageDefinition langDef;
    if (!inited) {
        static const char* const keywords[] = {"and",
            "abstract",
            "auto",
            "bool",
            "break",
        ...
        static const char* const identifiers[] = {"cos",
            "sin",
            "tab",
            "acos",
            "asin",
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua() {
    ...
    if (!inited) {
        ...
        static const char* const identifiers[] = {"assert",
            "collectgarbage",
            "dofile",
            "error",
            "getmetatable",
